...
const Quote = () => {
  return (
    <section className="w-full py-24 px-6 bg-transparent text-charcoal flex items-center justify-center relative overflow-hidden">
      ...
      >
        <p className="font-playfair text-2xl md:text-4xl leading-relaxed text-crimson italic">
          "Two souls with but a single thought, two hearts that beat as one."
        </p>
        <span className="block mt-8 font-montserrat text-sm tracking-[4px] text-charcoal/80 uppercase">
          — John Keats
        </span>
      </motion.div>
    </section>
